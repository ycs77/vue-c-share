/*!
 * vue-c-share.js v1.0.1
 * https://github.com/ycs77/vue-c-share
 *
 * Copyright 2020-2023 Lucas Yang
 * Released under the MIT license
 *
 * Date: 2023-12-11T12:21:49.510Z
 */

import { FontAwesomeIcon, FontAwesomeLayers, FontAwesomeLayersText } from '@fortawesome/vue-fontawesome';
import { library } from '@fortawesome/fontawesome-svg-core';
import { faCircle, faEnvelope } from '@fortawesome/free-solid-svg-icons';
import { faFacebookF, faLine, faWeibo, faTwitter, faTumblr } from '@fortawesome/free-brands-svg-icons';
...
__vue_render__._withStripped = true;
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-3c01c44a_0", { source: "\na[data-v-3c01c44a] {\n  display: inline-block;\n  text-decoration: none;\n  -webkit-transition:\n    -webkit-transform .2s,\n    -ms-transform .2s,\n    transform .2s;\n  -moz-transition:\n    -webkit-transform .2s,\n    -ms-transform .2s,\n    transform .2s;\n  transition:\n    -webkit-transform .2s,\n    -ms-transform .2s,\n    transform .2s;\n}\na[data-v-3c01c44a]:hover {\n  -webkit-transform: translateY(-4px);\n  -ms-transform: translateY(-4px);\n  transform: translateY(-4px);\n}\n.icon-fb[data-v-3c01c44a] {\n  color: #3B5998;\n}\n.fa-line[data-v-3c01c44a]  {\n  color: #00c300;\n}\n.icon-plurk[data-v-3c01c44a] {\n  color: #cf682f;\n}\n.icon-plurk ~ .fa-layers-text[data-v-3c01c44a] {\n  color: #ffffff;\n  font-family: arial;\n  font-style: normal;\n  font-weight: bold;\n}\n.icon-weibo[data-v-3c01c44a] {\n  color: #F5CA59;\n}\n.icon-twitter[data-v-3c01c44a] {\n  color: #2ba9e1;\n}\n.icon-tumblr[data-v-3c01c44a] {\n  color: #35465d;\n}\n.icon-email[data-v-3c01c44a] {\n  color: #939598;\n}\n", map: {"version":3,"sources":["D:\\dev\\packages\\vue-c-share\\src\\CShare.vue"],"names":[],"mappings":";AAgJA;EACA,qBAAA;EACA,qBAAA;EACA;;;iBAGA;EACA;;;iBAGA;EACA;;;iBAGA;AACA;AACA;EACA,mCAAA;EACA,+BAAA;EACA,2BAAA;AACA;AACA;EACA,cAAA;AACA;AACA;EACA,cAAA;AACA;AACA;EACA,cAAA;AACA;AACA;EACA,cAAA;EACA,kBAAA;EACA,kBAAA;EACA,iBAAA;AACA;AACA;EACA,cAAA;AACA;AACA;EACA,cAAA;AACA;AACA;EACA,cAAA;AACA;AACA;EACA,cAAA;AACA","file":"CShare.vue","sourcesContent":["<template>\n  <div>\n    <a\n      v-for=\"btnId in showButtons\"\n      :key=\"btnId\"\n      :href=\"buttons[btnId].href.call(null, href, description)\"\n      :title=\"`${shareToText} ${buttons[btnId].name}`\"\n      target=\"_blank\"\n      :style=\"linkStyle\"\n      @click=\"clickLink($event, buttons[btnId].href.call(null, href, description))\"\n    >\n      <fa-layers class=\"fa-2x\">\n        <fa icon=\"circle\" :class=\"`icon-${btnId}`\" v-if=\"!buttons[btnId].hideWrapper\"></fa>\n        <fa-layers-text\n          v-if=\"buttons[btnId].text\"\n          :transform=\"buttons[btnId].transform\"\n          :value=\"buttons[btnId].text\"\n        ></fa-layers-text>\n        <fa\n          v-else\n          :icon=\"buttons[btnId].fa\"\n          :transform=\"buttons[btnId].transform\"\n          :inverse=\"!buttons[btnId].hideWrapper\"\n        ></fa>\n      </fa-layers>\n    </a>\n  </div>\n</template>\n\n<script>\nimport {\n  FontAwesomeIcon as fa,\n  FontAwesomeLayers as faLayers,\n  FontAwesomeLayersText as faLayersText\n} from '@fortawesome/vue-fontawesome'\nimport { library } from '@fortawesome/fontawesome-svg-core'\nimport { faCircle, faEnvelope } from '@fortawesome/free-solid-svg-icons'\nimport {\n  faFacebookF,\n  faLine,\n  faWeibo,\n  faTwitter,\n  faTumblr\n} from '@fortawesome/free-brands-svg-icons'\n\nlibrary.add(faCircle)\nlibrary.add(faEnvelope)\nlibrary.add(faFacebookF)\nlibrary.add(faLine)\nlibrary.add(faWeibo)\nlibrary.add(faTwitter)\nlibrary.add(faTumblr)\n\nexport default {\n  name: 'CShare',\n  components: {\n    fa,\n    faLayers,\n    faLayersText\n  },\n  props: {\n    description: String,\n    showButtons: {\n      type: Array,\n      default: () => ['line', 'fb', 'twitter']\n    },\n    buttons: {\n      type: Object,\n      default: () => ({\n        fb: {\n          fa: ['fab', 'facebook-f'],\n          name: 'Fb',\n          href: url => `https://www.facebook.com/sharer.php?u=${url}`,\n          transform: 'shrink-9'\n        },\n        line: {\n          fa: ['fab', 'line'],\n          name: 'Line',\n          href: url => `https://social-plugins.line.me/lineit/share?url=${url}`,\n          transform: '',\n          hideWrapper: true\n        },\n        plurk: {\n          name: 'Plurk',\n          href: (url, description) => `http://www.plurk.com/?qualifier=shares&status=${description} ${url}`,\n          transform: 'shrink-9',\n          text: 'P'\n        },\n        weibo: {\n          fa: ['fab', 'weibo'],\n          name: '微博',\n          href: (url, description) => `http://service.weibo.com/share/share.php?title=${description}&url=${url}`,\n          transform: 'shrink-9'\n        },\n        twitter: {\n          fa: ['fab', 'twitter'],\n          name: 'Twitter',\n          href: (url, description) => `https://twitter.com/intent/tweet?original_referer=${url}&url=${url}&text=${description}`,\n          transform: 'shrink-9'\n        },\n        tumblr: {\n          fa: ['fab', 'tumblr'],\n          name: 'Tumblr',\n          href: (url, description) => `http://www.tumblr.com/share/link?name=${description} ${url}&url=${url}`,\n          transform: 'shrink-9'\n        },\n        email: {\n          fa: ['fas', 'envelope'],\n          name: 'E-mail',\n          href: (url, description) => `mailto:?subject=${description}&body=${description} ${url}`,\n          transform: 'shrink-9'\n        }\n      })\n    },\n    spacing: {\n      type: Number,\n      default: 6\n    },\n    shareToText: {\n      type: String,\n      default: 'Share to'\n    }\n  },\n  computed: {\n    href: () => encodeURIComponent(location.href.replace(/#\\w/, '')),\n    mobile: () => navigator.userAgent.match(/(mobile|android|pad)/i),\n    linkStyle() {\n      return {\n        margin: `auto ${Number(this.spacing) / 2}px`\n      }\n    }\n  },\n  methods: {\n    clickLink(e, href) {\n      if (!this.mobile) {\n        e.preventDefault()\n        window.open(href, '_blank', 'noopener,width=500,height=600')\n      }\n    }\n  }\n}\n</script>\n\n<style scoped>\na {\n  display: inline-block;\n  text-decoration: none;\n  -webkit-transition:\n    -webkit-transform .2s,\n    -ms-transform .2s,\n    transform .2s;\n  -moz-transition:\n    -webkit-transform .2s,\n    -ms-transform .2s,\n    transform .2s;\n  transition:\n    -webkit-transform .2s,\n    -ms-transform .2s,\n    transform .2s;\n}\na:hover {\n  -webkit-transform: translateY(-4px);\n  -ms-transform: translateY(-4px);\n  transform: translateY(-4px);\n}\n.icon-fb {\n  color: #3B5998;\n}\n.fa-line  {\n  color: #00c300;\n}\n.icon-plurk {\n  color: #cf682f;\n}\n.icon-plurk ~ .fa-layers-text {\n  color: #ffffff;\n  font-family: arial;\n  font-style: normal;\n  font-weight: bold;\n}\n.icon-weibo {\n  color: #F5CA59;\n}\n.icon-twitter {\n  color: #2ba9e1;\n}\n.icon-tumblr {\n  color: #35465d;\n}\n.icon-email {\n  color: #939598;\n}\n</style>\n"]}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-3c01c44a";
  /* module identifier */
