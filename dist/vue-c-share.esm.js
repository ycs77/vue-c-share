...
import { faFacebookF, faGooglePlusG, faLine, faWeibo, faTwitter, faTumblr, faPinterestP } from '@fortawesome/free-brands-svg-icons';
...
var script = {
  ...
  props: {
    ...
    showButtons: {
      ...
      //   'gPlus'
      // ]
      default: () => ['fb', 'gPlus', 'line', 'plurk', 'weibo', 'twitter', 'tumblr', 'pinterest', 'email']
    },
    buttons: {
      type: Object,
      default: () => ({
